...
function BiChoose() {
  return (
    ...
    <div className='text-center md:mt-10 overflow-x-hidden'>
                       <h6 className='leading-[1.1] md:text-MainHeading text-MainHeading-sm font-extrabold tracking-tight text-blue2'>Why choose us ???</h6>
       ...
       <div className="flex flex-col grid-cols-9 p-2 mx-auto md:grid">
           ...
           <div className="flex md:contents flex-row-reverse">
               ...
               whileInView={"show"}
               viewport={{ once: true, amount: 0.8 }}
                   className="relative p-4 my-6 md:my-0 text-gray-800  bg-blue7 border-green-500 rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto">
