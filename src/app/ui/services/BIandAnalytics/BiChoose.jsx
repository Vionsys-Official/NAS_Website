       ...
       <div className="flex flex-col grid-cols-9 p-2 mx-auto md:grid">
           <div className="flex md:contents flex-row-reverse">
               <motion.div
                ...
                className="relative p-4 my-6 text-gray-800 bg-blue7 rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto">
               ...
               <div className="relative col-start-5 col-end-6 mr-7 md:mx-auto">
                   <div className="flex items-center justify-center w-6 h-full">
                       <div className="w-1 h-full bg-blue7 rounded-t-full bg-gradient-to-r from- to-red-300">
                       </div>
                   </div>
           ...
           <div className="flex md:contents">
               ...
               <motion.div 
                ...
                whileInView={"show"}
                viewport={{ once: true, amount: 0.8 }}
               className="relative p-4 my-6 text-gray-800  bg-blue7 rounded-xl col-start-6 col-end-10 mr-auto">
           ...
           <div className="flex md:contents flex-row-reverse">
               ...
               whileInView={"show"}
               viewport={{ once: true, amount: 0.8 }}
                   className="relative p-4 my-6 md:my-0 text-gray-800  bg-blue7 border-blue2 rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto">
               ...
               <div className="relative col-start-5 col-end-6 mr-7 md:mx-auto">
                   <div className="flex items-center justify-center w-6 h-full">
                       <div className="w-1 h-full bg-blue7 rounded-t-full bg-gradient-to-b from-blue7 to-blue7">
                       </div>
                   </div>
                   <div className="absolute w-6 h-6 -mt-3  bg-green1 border-4 border-blue5 rounded-full top-1/2"></div>
               </div>
