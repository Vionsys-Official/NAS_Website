...
function s2() {
  ...
  <section2>
    <div className=' text-center md:mt-10 mt-5'>
                    <h6 className='text-3xl font-bold mt-3 text-blue-500'>Business Intelligence TOOLS</h6>
                <p className='mb-10 text-xl mt-3 text-blue-800'>Below mentioned are few and many more to learn!!!</p></div>
