...
const Solutions = () => {
    return (
        <section className="p-4 lg:p-12 ">
            <h2 className="mb-6 md:text-Heading text-Heading-sm font-bold leading-none text-center">Our IT Staffing Solutions</h2>
            <div className="mx-auto space-y-6">
                <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
                    ...
                    <div className="flex flex-col justify-center flex-1 md:p-6 p-2 bg-slate-100">
                        <h3 className="md:text-SubHeading text-SubHeading-sm font-bold">Contract Staffing</h3>
                        <ul>
                ...
                <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row-reverse">
                    ...
                    <div className="flex flex-col justify-center flex-1 md:p-6 p-2 bg-slate-100">
                        <h3 className="md:text-SubHeading text-SubHeading-sm font-bold">Contract-to-Hire Staffing</h3>
                        <ul>
                ...
                <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row">
                    ...
                    <div className="flex flex-col justify-center flex-1 md:p-6 p-2 bg-slate-100">
                        <h3 className="md:text-SubHeading text-SubHeading-sm font-bold">Direct Hire Staffing</h3>
                        <ul>
                ...
                <div className="flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row-reverse">
                    ...
                    <div className="flex flex-col justify-center flex-1 md:p-6 p-2 bg-slate-100">
                        <h3 className="md:text-SubHeading text-SubHeading-sm font-bold">Managed Services</h3>
                        <ul>
