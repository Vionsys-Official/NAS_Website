...
const Hero = () => {
  return (
    <div className="relative flex flex-col lg:pt-0 lg:flex-col lg:pb-0">
      <div className="order-2 flex flex-col items-start w-full max-w-xl px-4 mx-auto lg:px-8 lg:max-w-screen-xl">
        <div className="md:mb-16 md:py-0 py-3 mb-4 lg:my-40 lg:max-w-lg lg:pr-5">
          <div className="max-w-xl mb-6">
            <h2 className="max-w-lg md:mb-6 mb-2 md:text-MainHeading text-MainHeading-sm font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
              IT Staffing
            </h2>
            ...
            <Link href='/' className="inline-flex items-center justify-center w-full h-12 p-6 mb-3 font-medium tracking-wide text-black transition duration-200 rounded shadow-md md:w-auto md:mr-4 md:mb-0 bg-purple-400 hover:bg-purple-700 focus:shadow-outline focus:outline-none">Get Started</Link>
          </div>
        </div>
      </div>
