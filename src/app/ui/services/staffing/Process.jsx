            ...
            <div className="container max-w-5xl md:px-4 px-3 md:py-12 py-6 mx-auto">
                <div className="grid gap-4 md:mx-4 sm:grid-cols-12">
                    <motion.div
                        ...
                        initial="hidden"
                        whileInView={"show"}
                        viewport={{ once: false, amount: 0.8 }} className="col-span-12 sm:col-span-3">
                        ...
                        <div className="md:col-span-12 md:space-y-12 relative md:px-4 col-span-10 space-y-10 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:bg-gray-700 before:dark:bg-gray-300">
                            {process.map((item) => (
                                <motion.div
                                    ...
                                    initial="hidden"
                                    whileInView={"show"}
                                    viewport={{ once: false, amount: 0.8 }} key={item.id} className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:bg-blue5">
