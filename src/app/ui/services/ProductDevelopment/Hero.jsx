  ...
  return (
    <section className="pt-16">
      <div className="relative w-full h-[60vh] md:h-[100vh]">
        ...
        <div className="absolute inset-0 md:p-4 p-2 rounded-xl md:inset-y-0 md:right-20 flex md:justify-end justify-center items-center w-full">
          <motion.p
            variants={fadein("left", 0.2)}
            initial="hidden"
            whileInView={"show"}
            viewport={{ once: true, amount: 0.8 }}
            className="text-white text-SubHeading font-medium w-full px-4 py-4 md:py-2 md:w-[50vw] bg-black md:bg-opacity-50 bg-opacity-70"
          >
