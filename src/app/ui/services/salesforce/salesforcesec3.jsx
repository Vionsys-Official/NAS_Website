...
const salesforcesec3 = () => {
  return (
    <section>
      <h2 className=" text-center font-heading  bg-blue-100 text-blue-800 px-4 py-2 rounded-lg md:w-64 md:mx-auto text-SubHeading-sm font-semibold tracking-widest uppercase title-font">
        Why choose us?
      </h2>
        ...
        <div className="w-full lg:w-1/2">
          <div className="lg:max-w-lg">
            ...
            <p className="mt-4 text-gray-600 text-center dark:text-gray-300">
              Experience seamless Salesforce integration and expert support from
              our dedicated team, ensuring your business thrives with
