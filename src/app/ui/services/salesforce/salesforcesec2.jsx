      ...
      <div className="max-w-screen-xl mx-auto md:py-5 px-2">
        ...
        <div className="flex flex-col md:flex-row md:p-10 p-2 py-2">
          <div className="mr-0 md:mr-8 md:my-20 md:mb-0 py-4">
            <Image
              className="mx-auto shadow-xl shadow-gray-300"
              width={400}
              height={600}
              src={section2Image}
              alt="can_help_banner"
          ...
          >
            {salesforce.map((item) => (
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h3 className="font-semibold text-SubHeading-sm md:text-start text-center">
                  {item.title}
                  </h3>
                  <p className="mt-1 text-gray-500 md:text-start text-center">
                  {item.description}
                  </p>
                </div>
              </div>
