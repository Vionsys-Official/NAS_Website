            ...
            <div className="px-6 mx-auto">
                <div className="lg:flex lg:items-center">
                    <motion.div
                        ...
                        <div>
                            <h1 className="md:text-Heading text-Heading-sm font-bold text-blue950 capitalize">Our Software Development Services</h1>
                        ...
                        {serve.map((item) => (
                            <div key={item.id} className="md:flex md:items-start">
                                ...
                                <div className="">
                                    <h1 className="md:text-lg text-base font-semibold text-black hover:text-blue2 capitalize">{item.title}</h1>
                    ...
                    <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                        <Image className="w-[34rem] h-[28rem] object-cover xl:w-[36rem] xl:h-[28rem] rounded-full" src={SoftDev2} alt="" />
                    </div>
                </div>
            </div>
        </section>
