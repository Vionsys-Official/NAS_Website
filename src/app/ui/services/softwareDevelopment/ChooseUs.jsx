  ...
  return (
    <div className="px-4 md:pt-28 pt-14 pb-7 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <h2 className="max-w-lg mb-6 md:text-Heading text-Heading-sm font-bold leading-none tracking-tight text-black sm:text-4xl md:mx-auto">
        ...
        <p className="text-para-sm md:text-para">
      ...
      <div className="grid max-w-md md:gap-8 gap-2 row-gap-10 sm:mx-auto lg:max-w-full lg:grid-cols-3 ">
        {select.map ((item) => (
            ...
            <div>
              <h6 className="mb-2 md:text-lg text-base font-semibold leading-5">{item.title}</h6>
              <p className="mb-3 md:text-base text-sm text-gray-900">
              {item.para}
              </p>
            </div>
          </div>
