...
const sectionThree = () => {
  return (
    <section id='faqs'>
    <section className="relative max-w-full z-10 overflow-hidden bg-slate-100 pt-16 pb-10 px-8">
            ...
            <div className="w-full px-4">
                <div className="text-center lg:text-left ">
                    <div className="mb-10 lg:mb-0 ">
                        <h1
                            className="mt-0 mb-3 text-MainHeading font-extrabold leading-tight sm:leading-tight md:text-MainHeading md:leading-tight text-blue2 ">
                            Search Engine Optimization (SEO)</h1>
                        <p
                            className="w-full mb-8 text-base font-semibold leading-relaxed sm:text-md sm:leading-relaxed text-slate-600">
        ...
        <div className="flex flex-wrap items-center">
            <div className="w-full px-4">
                <div className="text-center lg:text-left ">
                    <div className="mb-10 lg:mb-0 ">
                        <h1
                            className="mt-0 mb-3 text-MainHeading-sm font-extrabold leading-tight md:text-MainHeading sm:leading-tight md:leading-tight text-blue2 ">
                            Pay-Per-Click Advertising (PPC)</h1>
                        <p
                            className="w-full mb-8 text-lg leading-relaxed sm:leading-relaxed text-slate-600 font-semibold">
...
<section className="relative max-w-full z-10 overflow-hidden bg-blue5 pt-16 pb-10 px-8">
    <div className="container">
        <div className="flex flex-wrap items-center">
            <div className="w-full px-4">
                <div className="text-center lg:text-left ">
                    <div className="mb-10 lg:mb-0 ">
                        ...
                        <p
                            className="w-full mb-8 text-lg font-semibold leading-relaxed sm:leading-relaxed text-gray-200">
