    ...
    <div className="w-full bg-white md:pt-6 pt-2">
      <div className="w-full flex flex-col justify-center items-center md:gap-6 gap-3">
        <motion.h1
          ...
          className="md:text-Heading text-Heading-sm text-blue2 font-extrabold"
        >
          Our Approach
        </motion.h1>
        <motion.p
          ...
          whileInView={"show"}
          viewport={{ once: true, amount: 0.8 }}
          className="text-lg font-semibold text-slate-600 md:w-1/2 w-full text-center"
        >
      ...
      >
        <div className="grid gap-8 sm:row-gap- grid-cols-1 md:grid-cols-3">
          <div className="md:p-8 border-b sm:border-r">
            <div className="max-w-md text-center">
              <div className="flex items-center justify-center w-16 h-16 mx-auto md:mb-4 mb-2 rounded-full bg-blue4 sm:w-16 sm:h-16">
          ...
          <div className="md:p-8 border-b lg:border-r">
            <div className="max-w-md text-center">
              <div className="flex items-center justify-center w-16 h-16 mx-auto md:mb-4 mb-2 rounded-full bg-blue4 sm:w-16 sm:h-16">
          ...
          <div className="md:p-8 border-b sm:border-r lg:border-r-0">
            <div className="max-w-md text-center">
              <div className="flex items-center justify-center w-16 h-16 mx-auto md:mb-4 mb-2 rounded-full bg-blue4 sm:w-16 sm:h-16">
          ...
          <div className="md:p-8 border-b lg:border-b-0 lg:border-r">
            <div className="max-w-md text-center">
              <div className="flex items-center justify-center w-16 h-16 mx-auto md:mb-4 mb-2 rounded-full bg-blue4 sm:w-16 sm:h-16">
          ...
          <div className="md:p-8 border-b sm:border-b-0 sm:border-r">
            <div className="max-w-md text-center">
              <div className="flex items-center justify-center w-16 h-16 mx-auto md:mb-4 mb-2 rounded-full bg-blue4 vsm:w-16 sm:h-16">
