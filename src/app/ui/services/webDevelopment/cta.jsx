  ...
  return (
    <div className='flex items-center justify-center'>
        <div className='flex flex-wrap gap-4 items-center justify-center w-[94%] md:w-4/6 p-6 m-10 bg-gradient-to-br from-green-200 to-green-300 rounded-bl-[20%] rounded-tr-[20%] shadow-md shadow-gray-400'>
            <div className='text-SubHeading-sm md:text-SubHeading text-center font-semibold cursor-pointer'>Contact us today to schedule a consultation and take the first step towards a stunning and effective website that stands out from the competition!</div>
            <Link href="#" className=''>
