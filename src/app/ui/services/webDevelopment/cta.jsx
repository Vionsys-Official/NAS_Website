  ...
  return (
    ...
    <div className='w-[94%] md:w-4/6 flex items-center justify-center'>
        <motion.div
            ...
            className='flex flex-wrap gap-4 items-center justify-center p-6 m-10 bg-gradient-to-br from-green-200 to-green-300 rounded-bl-[20%] rounded-tr-[20%] shadow-md shadow-gray-400'>
