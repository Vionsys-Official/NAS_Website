...
const cta = () => {
  return (
    ...
    <div className='w-[94%] md:w-4/6 flex items-center justify-center'>
        <div className='flex flex-wrap gap-4 items-center justify-center p-6 m-10 bg-gradient-to-br from-slate-100 to-slate-300 rounded-bl-[20%] rounded-tr-[20%] shadow-md shadow-gray-400'>
            <div className='text-blue5 px-4 font-sans text-CardHeading-sm md:text-CardHeading text-center font-bold cursor-pointer'>Contact us today to schedule a consultation and take the first step towards a stunning and effective website that stands out from the competition!</div>
            <Link href="#" className=''>
