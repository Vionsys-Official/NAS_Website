    ...
    <div className='py-4 overflow-hidden'>
        <div className='flex flex-col items-center justify-center'>
            ...
            viewport={{ once: true, amount: 0.8 }}
              className="mb-6 text-blue2 text-MainHeading-sm md:text-MainHeading md:p-6 font-extrabold leading-none tracking-tight cursor-pointer">
            ...
            <div className='w-[100%] md:pl-20 flex flex-wrap gap-4 md:gap-10 items-center justify-center'>
                {items.map((feat)=>{
                    return(
                        ...
                        whileInView={"show"}
                        viewport={{ once: true, amount: 0.8 }}
                        key={feat.id} className='w-[90%] rounded-lg md:w-2/5 lg:w-1/4 h-full md:h-[27rem] lg:h-[32rem] xl:h-[26rem] flex flex-col items-center justify-start shadow-md shadow-gray-300 p-2 hover:bg-[#c4e4ee] cursor-pointer'>
