    ...
    <div className='flex items-center justify-center'>
        <div className='w-[80%] flex flex-col items-center justify-center'>
            ...
            viewport={{ once: true, amount: 0.8 }}
             className="text-blue2 mb-6 sm:mt-6 text-Heading-sm md:text-Heading md:p-6 font-extrabold leading-none tracking-tight">
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                {steps.map((feat)=>{
                    return(
                        ...
                        whileInView={"show"}
                        viewport={{ once: true, amount: 0.8 }}
                        key={feat.id} className='flex flex-row p-2 border border-gray hover:scale-105 hover:bg-green-50 ease-out'>
