...
const OurService = () => {
    ...
    const service = [
        {
            id: 1,
            ques: "Continuous Integration/Continuous Deployment (CI/CD)",
  ...
  return (
    <div className="px-4 py-6 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      ...
      <div className="grid gap-8 row-gap-5 mb-8 md:row-gap-8 lg:grid-cols-4 sm:grid-cols-2">
        {service.map ((item) => (
            <div key={item.id} className="duration-300 transform bg-white border-l-4 border-purple-400 hover:-translate-y-6">
