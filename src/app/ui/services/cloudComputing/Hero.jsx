  ...
  return (
    <div>
        <div className="relative bg-black">
          <Image src={Cloud} alt='' className="inset-0 object-cover w-full md:h-full h-[80vh] opacity-55" />
          <div className="absolute inset-y-0 right-0 md:w-1/2 w-full flex flex-col justify-center items-center">
