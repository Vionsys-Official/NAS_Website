      ...
      <section className="h-full w-full">
        <div className="px-4 md:py-20 py-6 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-14">
          ...
          <div className="flex flex-col mb-6 lg:justify-evenly lg:flex-row  ">
            <h2 className="max-w-lg mb-5 text-blue-900 font-sans text-2xl font-bold tracking-tight  sm:text-4xl sm:leading-none md:mb-6 group text-center">
            ...
            <p className="tracking-wide lg:text-xl lg:max-w-xl text-center md:border-l-4 md:pl-8 border-green-400 p-2 text-black ">
          ...
          <div className="grid gap-6 row-gap-5  lg:grid-cols-3 sm:row-gap-6 sm:grid-cols-2 md:py-10">
            ...
            <Link href="/" aria-label="View Item">
              <h1 className="text-center py-2 text-xl border-t-2 border-blue-600 rounded-md text-blue-700 font-extrabold">
