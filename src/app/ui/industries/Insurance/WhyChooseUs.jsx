      ...
      <div class="flex flex-col grid-cols-9 p-2 mx-auto md:grid">
        <div class="flex md:contents flex-row-reverse">
          <motion.div
            ...
            className="relative p-4 my-6 text-gray-800 bg-blue-400 rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto"
          >
        ...
        <div className="flex md:contents">
          <div className="relative col-start-5 col-end-6 mr-7 md:mx-auto">
            ...
            <div className="absolute w-6 h-6 -mt-3   bg-blue-400 border-4 border-red-500 rounded-full top-1/2"></div>
          </div>
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.8 }}
            className="relative p-4 my-6 text-gray-800  bg-blue-400 rounded-xl col-start-6 col-end-10 mr-auto"
          >
        ...
        <div className="flex md:contents flex-row-reverse">
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.8 }}
            className="relative p-4 my-6 text-gray-800  bg-blue-400 border-red-500 rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto"
          >
            <h3 className="md:text-HSub text-HSub-sm font-semibold lg:text-xl">
