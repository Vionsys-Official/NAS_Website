...
const OtherInfor = () => {
    return (
        <div className='py-10'>
            <div className='py-5'>
                <h2 className="max-w-6xl mx-auto text-center md:text-Heading text-Heading-sm font-bold tracking-tight text-black text-2xl sm:leading-none">Integrated Solutions for Technological Innovation, Regulatory Compliance, and Customization in Pharmaceuticals.</h2>
            </div>
            <div className="p-2 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-6">
