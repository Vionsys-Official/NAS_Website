    ...
    return (
        <div className='w-full h-full'>
            <motion.div
                ...
                className="mx-auto lg:pt-40 pt-20 flex flex-col mb-16 sm:text-center sm:mb-0">
                <div className="max-w-xl mb-10 md:mx-auto text-center lg:max-w-2xl md:mb-12">
                    <h2 className="text-blue950 max-w-lg mb-6 md:text-HMain text-HMain-sm font-bold leading-none tracking-tight sm:text-5xl md:mx-auto">
                        <span className="relative inline-block">
                            <svg
                                viewBox="0 0 52 24"
                                fill="currentColor"
                                className="absolute top-0 left-0 z-0 hidden w-32 -mt-8 -ml-20 text-blue950 lg:w-32 lg:-ml-28 lg:-mt-10 sm:block"
                            >
                                <defs>
                                    <pattern
