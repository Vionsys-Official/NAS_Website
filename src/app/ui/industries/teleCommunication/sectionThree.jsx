...
const sectionThree = () => {
  return (
    <section className="flex items-center justify-center">
      <div className=" pb-5 mx-auto md:w-[76%] w-full p-1 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-16 lg:px-8 ">
        <h2 className="text-blue-900 font-bold md:text-MainHeading text-MainHeading-sm pb-8">
          Why Choose Us ?
        </h2>
