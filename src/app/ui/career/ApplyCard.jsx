    ...
    <div id="card" className='py-4 md:py-10'>
      <div className='flex flex-col items-center justify-center'>
        ...
        <div className='w-[90%] grid grid-col-1 md:grid-cols-2 lg:grid-cols-3 items-center justify-center gap-2 md:gap-6'>
          {CardData.map((feat)=>{
            return(
              <div key={feat.id} className='p-6 bg-slate-50 shadow-lg shadow-gray-400 border border-gray-100 rounded-md hover:border-2 hover:border-gray-300 cursor-pointer transition-all hover:scale-[101%] eas'>
