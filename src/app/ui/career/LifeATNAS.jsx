        ...
        <section className=' flex flex-col gap-2'>
          <div className='flex flex-wrap group overflow-hidden bg-opacity-40 bg-blue4 h-full md:h-[26vh] items-center justify-center cursor-pointer hover:shadow-xl shadow-gray-300'>
            ...
            className='flex flex-col justify-center w-full md:w-2/3 md:h-[26vh] p-4 lg:p-10'>
              <h3 className='text-blue-950 text-CardHeading-sm md:text-CardHeading font-semibold font-sans'>Inclusive Environment</h3>
          ...
          <div className='flex flex-wrap hover:shadow-xl shadow-gray-300 group overflow-hidden bg-opacity-40 bg-green2 h-full md:h-[26vh] items-center justify-center cursor-pointer'>
            <motion.div 
          ...
          <div className='flex flex-wrap hover:shadow-xl shadow-gray-300 group overflow-hidden bg-opacity-40 bg-blue4 h-full md:h-[26vh] items-center justify-center cursor-pointer'>
            <div className='w-full md:w-1/3 h-[26vh] overflow-hidden'>
          ...
          <div className='flex flex-wrap hover:shadow-xl shadow-gray-300 group overflow-hidden bg-opacity-40 bg-green2 h-full md:h-[26vh] items-center justify-center cursor-pointer'>
            ...
            className='flex flex-col justify-center text-start w-full md:w-2/3 md:h-[26vh] p-4 lg:p-10'>
              <h3 className='text-blue-950 text-CardHeading-sm md:text-CardHeading font-semibold font-sans'>Community Involvement</h3>
