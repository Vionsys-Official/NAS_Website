  ...
  return (
    ...
    <div className='w-[90%] flex flex-col items-center justify-center font-light'>
        ...
        viewport={{ once: true, amount: 0.8 }}
         className='text-blue-900 text-center text-MainHeading-sm md:text-MainHeading font-semibold'>Life at NAS Infotech</motion.h1>
        <motion.p 
        variants={fadein("left", 0.2)}
        initial="hidden"
        whileInView={"show"}
        viewport={{ once: true, amount: 0.8 }}
        className='text-blue-950 text-center text-Para-sm md:text-Para font-medium p-4 md:p-6'>At NAS Infotech, we believe that work should be more than just a job – it should be a place where you can thrive, grow and enjoy every day. Here’s a glimpse into what life is like at our company:</motion.p>
        <section className=' flex flex-col gap-2'>
          <div className='flex flex-wrap group overflow-hidden bg-opacity-40 bg-blue4 h-full md:h-[26vh] items-center justify-center hover:shadow-xl shadow-gray-300'>
            ...
            className='flex flex-col justify-center w-full md:w-2/3 md:h-[26vh] p-4 lg:p-10'>
              <h3 className='text-blue-950 text-CardHeading-sm md:text-CardHeading font-semibold'>Inclusive Environment</h3>
          ...
          <div className='flex flex-wrap hover:shadow-xl shadow-gray-300 group overflow-hidden bg-opacity-40 bg-green2 h-full md:h-[26vh] items-center justify-center'>
            <motion.div 
            ...
            viewport={{ once: true, amount: 0.8 }}
            className='flex flex-col justify-center w-full md:w-2/3 md:h-[26vh] p-4 lg:p-10'>
              <h3 className='text-blue-950 text-CardHeading-sm md:text-CardHeading font-semibold'>Fun & Engaging</h3>
          ...
          <div className='flex flex-wrap hover:shadow-xl shadow-gray-300 group overflow-hidden bg-opacity-40 bg-blue4 h-full md:h-[26vh] items-center justify-center'>
            <div className='w-full md:w-1/3 h-[26vh] overflow-hidden'>
            ...
            viewport={{ once: true, amount: 0.8 }}
            className='flex flex-col justify-center w-full md:w-2/3 md:h-[26vh] p-4 lg:p-10'>
              <h3 className='text-blue-950 text-CardHeading-sm md:text-CardHeading font-semibold'>Professional Development</h3>
          ...
          <div className='flex flex-wrap hover:shadow-xl shadow-gray-300 group overflow-hidden bg-opacity-40 bg-green2 h-full md:h-[26vh] items-center justify-center'>
            ...
            whileInView={"show"}
            viewport={{ once: true, amount: 0.8 }}
            className='flex flex-col justify-center text-start w-full md:w-2/3 md:h-[26vh] p-4 lg:p-10'>
              <h3 className='text-blue-950 text-CardHeading-sm md:text-CardHeading font-semibold'>Community Involvement</h3>
