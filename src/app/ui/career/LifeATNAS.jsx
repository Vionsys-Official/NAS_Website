  ...
  return (
    ...
    <div className='w-[90%] flex flex-col items-center justify-center font-light'>
        ...
        <section className=' flex flex-col gap-2'>
          <div className='flex flex-wrap group overflow-hidden bg-opacity-30 bg-blue-500 h-full md:h-[26vh] items-center justify-center cursor-pointer hover:shadow-xl shadow-gray-300'>
          ...
          <div className='flex flex-wrap hover:shadow-xl shadow-gray-300 group overflow-hidden bg-opacity-30 bg-green-500 h-full md:h-[26vh] items-center justify-center cursor-pointer'>
            <motion.div 
          ...
          <div className='flex flex-wrap hover:shadow-xl shadow-gray-300 group overflow-hidden bg-opacity-30 bg-blue-500 h-full md:h-[26vh] items-center justify-center cursor-pointer'>
            <div className='w-full md:w-1/3 h-[26vh] overflow-hidden'>
