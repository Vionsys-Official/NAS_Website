  ...
  return (
    <div className='flex flex-col items-center justify-center'>
        ...
        <section className='w-[90%] flex flex-col gap-2'>
          <div className='flex flex-wrap group overflow-hidden bg-blue-200 h-full md:h-[30vh] items-center justify-center cursor-pointer hover:border-2 border-gray-600'>
            ...
            <div className='w-full md:w-2/3 md:h-[30vh] p-4 lg:p-10'>
              <h3 className='text-MainHeading-sm md:text-MainHeading font-semibold'>Inclusive Environment</h3>
          ...
          <div className='flex flex-wrap hover:border-2 border-gray-600 group overflow-hidden bg-green-200 h-full md:h-[30vh] items-center justify-center cursor-pointer'>
            <div className='w-full md:w-2/3 md:h-[30vh] p-4 lg:p-10'>
              <h3 className='text-MainHeading-sm md:text-MainHeading font-semibold'>Fun & Engaging</h3>
          ...
          <div className='flex flex-wrap hover:border-2 border-gray-600 group overflow-hidden bg-blue-200 h-full md:h-[30vh] items-center justify-center cursor-pointer'>
            <div className='w-full md:w-1/3 h-[30vh]'>
            ...
            <div className='w-full md:w-2/3 md:h-[30vh] p-4 lg:p-10'>
              <h3 className='text-MainHeading-sm md:text-MainHeading font-semibold'>Professional Development</h3>
          ...
          <div className='flex flex-wrap hover:border-2 border-gray-600 group overflow-hidden bg-green-200 h-full md:h-[30vh] items-center justify-center cursor-pointer'>
            <div className='w-full md:w-2/3 md:h-[30vh] p-4 lg:p-10'>
              <h3 className='text-MainHeading-sm md:text-MainHeading font-semibold'>Community Involvement</h3>
