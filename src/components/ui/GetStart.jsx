    ...
    return (
        <div>
            <div className="max-w-xl md:mx-auto sm:text-center lg:max-w-2xl py-8">
                ...
                <p className="text-base text-gray-700 md:text-lg py-4">Ready to transform your business with our top-notch services? Contact us today for a free consultation and see how we can help you achieve your business goals.</p>
                <Link
                    href="/"
